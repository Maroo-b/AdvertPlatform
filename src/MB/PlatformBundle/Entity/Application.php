 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="MB\PlatformBundle\Entity\ApplicationRepository")
 */
class Application
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MB\PlatformBundle\Entity\Advert" , inversedBy="applications")
